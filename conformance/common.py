...
SCHEMA_FILES = {
    ...
    "se.findings/1": SCHEMA_DIR / "findings.schema.json",
    "se.hub-findings/1": SCHEMA_DIR / "hub-findings.schema.json",
    "se.hub-transitions/1": SCHEMA_DIR / "hub-transitions.schema.json",
}
