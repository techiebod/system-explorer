...
NAMED_RESIDUALS = {
    ...
    "hardware/no-disk-in-either-walk": (
        ...
        "— and the whole nvme collection, all seventeen facts, because qemu's "
        "NVMe device is not expressible in libvirt's disk XML and would need a "
        "<qemu:commandline> override. Both are lab work rather than rulings."
    ),
