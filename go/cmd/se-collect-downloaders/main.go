// Command se-collect-downloaders is the transfer-tier collector: the download
// clients an estate's managers dispatch to, and the transfers sitting in them.
// It reads one request line on standard input and writes to standard output;
