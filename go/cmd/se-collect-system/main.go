// Command se-collect-system is the system-identity collector — the first Go
// implementation of the collector contract (DESIGN 18). It reads one request
// line on standard input and writes to standard output; under socket
