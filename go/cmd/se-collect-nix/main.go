// Command se-collect-nix is the NixOS generations collector. It reads one
...
//
// It answers what a host HAS BEEN. What CHANGED between two generations is
// deliberately not here: that left the rewrite's scope by ruling (DESIGN's
// adjudication queue, 2026-08-19) and becomes a plugin once a plugin surface
// exists, so this collector and the shipping Python adapter disagree by
// construction on five delta facts and must agree on every other.
package main
